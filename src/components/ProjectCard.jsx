...
export default function ProjectCard({ project, index }) {
    ...
    return (
        <motion.div
            ref={cardRef}
            className={`project-card ${hasLink ? 'project-card--clickable' : ''}`}
            data-cursor-hover
            onMouseMove={!hasDriveVideo && !hasLink ? handleMouseMove : undefined}
            onMouseLeave={!hasDriveVideo && !hasLink ? handleMouseLeave : undefined}
            onClick={handleClick}
            style={{
                transform: hasDriveVideo || hasLink
                    ? undefined
        ...
        >
            <div className="project-card-media">
                ...
                {!hasDriveVideo && !hasLink && <div className="project-card-overlay" />}
            </div>
